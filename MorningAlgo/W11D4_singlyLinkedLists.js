...
class SinglyLinkedList {
    ...
    */
    prepend(newVal, targetVal) {
        ...
        const newValNode = new ListNode(newVal);

        // if head is targetVal
        if (this.head.data === targetVal) {
            newValNode.next = this.head;
            this.head = newValNode;
            return true;
        }

        let runner = this.head;
        while (runner.next) {
            if (targetVal === runner.next.data) {
                newValNode.next = runner.next;
                runner.next = newValNode;
                return true;
            }
            runner = runner.next;
        }
...
console.log(firstThreeList.toArr());
console.log(firstThreeList.prepend(7, 4));
console.log(firstThreeList.toArr());